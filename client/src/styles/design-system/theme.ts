// client/src/styles/design-system/theme.ts - Site-wide design tokens
...
export const cssVariables = {
  // Background Colors
  '--color-bg-primary': globalDesignSystem.colors.bg.primary,
  '--color-bg-secondary': globalDesignSystem.colors.bg.secondary,
  '--color-bg-tertiary': globalDesignSystem.colors.bg.tertiary,
  
  // Text Colors
  '--color-text-primary': globalDesignSystem.colors.text.primary,
  '--color-text-secondary': globalDesignSystem.colors.text.secondary,
  '--color-text-muted': globalDesignSystem.colors.text.muted,
  
  // Brand Colors
  '--color-brand-blue': globalDesignSystem.colors.brand.blue,
  '--color-brand-blue-hover': globalDesignSystem.colors.brand.blueHover,
  '--color-brand-green': globalDesignSystem.colors.brand.green,
  '--color-brand-green-hover': globalDesignSystem.colors.brand.greenHover,
  
  // Border Colors
  '--color-border-default': globalDesignSystem.colors.border.default,
  '--color-border-hover': globalDesignSystem.colors.border.hover,
  '--color-border-focus': globalDesignSystem.colors.border.focus
};