    ...
    <div className="space-y-4">
      ...
      <div className="text-center space-y-2">
        <div className="flex items-center justify-center gap-2">
          ...
          <h4 className="text-lg font-semibold text-white">Your Security Matters</h4>
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <div className="flex items-center gap-1 px-3 py-1 bg-glass-secondary rounded-full border border-glass-border">
      ...
      {/* Privacy Notice */}
      <div className="flex items-center justify-center gap-2 p-3 glass rounded-lg border border-glass-border">
