...
- **Unified Dropdown System**: Glass morphism dropdown component (`UnifiedDropdown`) with seamless nav search bar styling, custom typing functionality, and proper value persistence. Replaced all legacy Select components across Contact, Sell-to-Us, and Admin pages.
